...
extern void HYDRO_TestProbSol_PlummerStatic( real fluid[], const double x, const double y, const double z, const double Time );
...
// set boundary condition to the analytical hydrostatic solution
   HYDRO_TestProbSol_PlummerStatic( BVal, x, y, z, Time );
