...
> [!CAUTION]
> When enabling [[--openmp | Installation:-Generate-Makefile#--openmp]],
...
[[--tracer | Installation:-Generate-Makefile#--tracer]].
...
[[--passive | Installation:-Generate-Makefile#--passive]]>0) yet.
...
`8` + [[--par_attribute | Installation:-Generate-Makefile#--par_attribute]],
...
[[--par_attribute | Installation:-Generate-Makefile#--par_attribute]] &nbsp;
...
* #### `OPT__UM_IC_LEVEL` &ensp; (0 &#8804; input < [[--nlevel | Installation:-Generate-Makefile#--nlevel]]) &ensp; [0]
    * **Description:**
...
* #### `OPT__UM_IC_NLEVEL` &ensp; (1 &#8804; input &#8804; [[--nlevel | Installation:-Generate-Makefile#--nlevel]]-[OPT__UM_IC_LEVEL](#OPT__UM_IC_LEVEL)) &ensp; [1]
    * **Description:**
...
5+[[--passive | Installation:-Generate-Makefile#--passive]]
for [[--model | Installation:-Generate-Makefile#--model]]=HYDRO.
See [Setting IC from Files &#8212; Grids](#IC-File-Grids) for details.
    * **Restriction:**
...
* #### `OPT__UM_IC_FLOAT8` &ensp; (<0: same as [[--double | Installation:-Generate-Makefile#--double]], 0=single precision, 1=double precision) &ensp; [-1]
    * **Description:**
