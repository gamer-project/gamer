...
| FB_RESOLVED_SNEII                                                                                    |               0 |            None |            None | Type II supernovae feedback for high enough grid and particle resolution (must add one extra PAR_NATT_FLT_USER) |
| FB_RESOLVED_SNEII_DELAY_TIME                                                                         |            10.0 |             0.0 |            None | explosion delay time of SNeII after star formation (in Myr) (for FB_RESOLVED_SNEII only) [10.0] |
| FB_RESOLVED_SNEII_EJECT_ENGY                                                                         |          1.0e51 |             0.0 |            None | ejected internal energy of each SNeII explosion (in erg) (for FB_RESOLVED_SNEII only) [1.0e51] |
| FB_RESOLVED_SNEII_EJECT_MASS                                                                         |             0.0 |             0.0 |            None | ejected total mass of each SNeII explosion (in Msun) (for FB_RESOLVED_SNEII only) [0.0] |
| FB_RESOLVED_SNEII_EJECT_METAL                                                                        |             0.0 |             0.0 |            None | ejected metal mass of each SNeII explosion (in Msun) (for FB_RESOLVED_SNEII only) [0.0] |
| FB_RESOLVED_SNEII_N_PER_MASS                                                                         |          1.0e-2 |             0.0 |            None | number of SNeII per stellar mass (in 1/Msun) (for FB_RESOLVED_SNEII only) [0.01] |
