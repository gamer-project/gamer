...
| [[ FB_RESOLVED_SNEII_EJECT_MASS \| Runtime-Parameters:-Feedback#FB_RESOLVED_SNEII_EJECT_MASS ]]      |             0.0 |             0.0 |            None | ejected total mass of each SNeII explosion (in Msun) (for FB_RESOLVED_SNEII only) [0.0] |
| [[ FB_RESOLVED_SNEII_EJECT_METAL \| Runtime-Parameters:-Feedback#FB_RESOLVED_SNEII_EJECT_METAL ]]    |             0.0 |             0.0 |            None | ejected metal mass of each SNeII explosion (in Msun) (for FB_RESOLVED_SNEII only) [0.0] |
| [[ FB_RESOLVED_SNEII_MIN_M_GAS \| Runtime-Parameters:-Feedback#FB_RESOLVED_SNEII_MIN_M_GAS ]]        |             0.0 |             0.0 |            None | minimum mass of gas in the environment of SNeII to apply feedback (in Msun) (for FB_RESOLVED_SNEII only) [0.0] |
| [[ FB_RESOLVED_SNEII_N_PER_MASS \| Runtime-Parameters:-Feedback#FB_RESOLVED_SNEII_N_PER_MASS ]]      |          1.0e-2 |             0.0 |            None | number of SNeII per stellar mass (in 1/Msun) (for FB_RESOLVED_SNEII only) [0.01] |
| [[ FB_RESOLVED_SNEII_RECORD \| Runtime-Parameters:-Feedback#FB_RESOLVED_SNEII_RECORD ]]              |               0 |            None |            None | record the SNeII explosion info (for FB_RESOLVED_SNEII only) [0] |
