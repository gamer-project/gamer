...
| [[ OPT__FIXUP_FLUX \| Hydro#OPT__FIXUP_FLUX ]]                                                       |               0 |            None |            None | correct coarse grids by the fine-grid boundary fluxes [1] ##HYDRO and ELBDM ONLY## |
...
| OPT__LB_EXCHANGE_FATHER                                                                              |               1 |            None |            None | exchange all cells of all father patches during load balancing (must enable for hybrid scheme + MPI) [0 usually, 1 for ELBDM_HYBRID] ## ELBDM_HYBRID ONLY### |
| OPT__LB_EXCHANGE_FATHER                                                                              |               0 |            None |            None | exchange all cells of all father patches during load balancing (must enable for hybrid scheme + MPI) [0 usually, 1 for ELBDM_HYBRID] ## ELBDM_HYBRID ONLY### |
...
| [[ OPT__OUTPUT_PAR_MESH \| Outputs#OPT__OUTPUT_PAR_MESH ]]                                           |               1 |            None |            None | output the attributes of tracer particles mapped from mesh quantities -> edit "Input__Par_Mesh" [1] ##PARTICLE ONLY## |
| [[ OPT__OUTPUT_PAR_MESH \| Outputs#OPT__OUTPUT_PAR_MESH ]]                                           |               0 |            None |            None | output the attributes of tracer particles mapped from mesh quantities -> edit "Input__Par_Mesh" [1] ##PARTICLE ONLY## |
