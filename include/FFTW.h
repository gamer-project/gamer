...
using      complex_plan         = gamer_fftw::complex_plan;
...
using      complex_plan         = gamer_fftw::complex_mpi_plan;
...
#if ( SUPPORT_FFTW == FFTW3 )
#ifdef SERIAL
#define root_fftw_r2c(plan, arr)                                    gamer_fftw::execute_dft_r2c     ( plan,                      (real*)                arr, (gamer_fftw::complex*) arr )
#define root_fftw_c2r(plan, arr)                                    gamer_fftw::execute_dft_c2r     ( plan,                      (gamer_fftw::complex*) arr, (real*)                arr )
#define root_fftw_c2c(plan, arr)                                    gamer_fftw::execute_dft_c2c     ( plan,                      (gamer_fftw::complex*) arr, (gamer_fftw::complex*) arr )
#define root_fftw_create_3d_r2c_plan(size, arr, startup)            gamer_fftw::plan_dft_r2c_3d     ( size[2], size[1], size[0], (real*)                arr, (gamer_fftw::complex*) arr,                startup )
#define root_fftw_create_3d_c2r_plan(size, arr, startup)            gamer_fftw::plan_dft_c2r_3d     ( size[2], size[1], size[0], (gamer_fftw::complex*) arr, (real*)                arr,                startup )
#define root_fftw_create_3d_forward_c2c_plan(size, arr, startup)    gamer_fftw::plan_dft_c2c_3d     ( size[2], size[1], size[0], (gamer_fftw::complex*) arr, (gamer_fftw::complex*) arr, FFTW_FORWARD , startup )
#define root_fftw_create_3d_backward_c2c_plan(size, arr, startup)   gamer_fftw::plan_dft_c2c_3d     ( size[2], size[1], size[0], (gamer_fftw::complex*) arr, (gamer_fftw::complex*) arr, FFTW_BACKWARD, startup )
#else  // #ifdef SERIA L
#define root_fftw_r2c(plan, arr)                                    gamer_fftw::mpi_execute_dft_r2c ( plan,                      (real*)                arr, (gamer_fftw::complex*) arr )
#define root_fftw_c2r(plan, arr)                                    gamer_fftw::mpi_execute_dft_c2r ( plan,                      (gamer_fftw::complex*) arr, (real*)                arr )
#define root_fftw_c2c(plan, arr)                                    gamer_fftw::mpi_execute_dft_c2c ( plan,                      (gamer_fftw::complex*) arr, (gamer_fftw::complex*) arr )
#define root_fftw_create_3d_r2c_plan(size, arr, startup)            gamer_fftw::mpi_plan_dft_r2c_3d ( size[2], size[1], size[0], (real*)                arr, (gamer_fftw::complex*) arr, MPI_COMM_WORLD,                startup | FFTW_MPI_TRANSPOSED_OUT )
#define root_fftw_create_3d_c2r_plan(size, arr, startup)            gamer_fftw::mpi_plan_dft_c2r_3d ( size[2], size[1], size[0], (gamer_fftw::complex*) arr, (real*)                arr, MPI_COMM_WORLD,                startup | FFTW_MPI_TRANSPOSED_IN  )
#define root_fftw_create_3d_forward_c2c_plan(size, arr, startup)    gamer_fftw::mpi_plan_dft_c2c_3d ( size[2], size[1], size[0], (gamer_fftw::complex*) arr, (gamer_fftw::complex*) arr, MPI_COMM_WORLD, FFTW_FORWARD , startup | FFTW_MPI_TRANSPOSED_OUT )
#define root_fftw_create_3d_backward_c2c_plan(size, arr, startup)   gamer_fftw::mpi_plan_dft_c2c_3d ( size[2], size[1], size[0], (gamer_fftw::complex*) arr, (gamer_fftw::complex*) arr, MPI_COMM_WORLD, FFTW_BACKWARD, startup | FFTW_MPI_TRANSPOSED_IN  )
...
#define root_fftw_r2c(plan, arr)                                    gamer_fftw::execute_dft_r2c     ( plan,                      (real*)                arr, NULL )
#define root_fftw_c2r(plan, arr)                                    gamer_fftw::execute_dft_c2r     ( plan,                      (gamer_fftw::complex*) arr, NULL )
#define root_fftw_c2c(plan, arr)                                    gamer_fftw::execute_dft_c2c     ( plan,                      (gamer_fftw::complex*) arr, NULL )
#else  // #ifdef SERIAL
#define root_fftw_r2c(plan, arr)                                    gamer_fftw::mpi_execute_dft_r2c ( plan, 1,                   (real*)                arr, NULL, FFTW_TRANSPOSED_ORDER )
#define root_fftw_c2r(plan, arr)                                    gamer_fftw::mpi_execute_dft_c2r ( plan, 1,                   (real*)                arr, NULL, FFTW_TRANSPOSED_ORDER )
#define root_fftw_c2c(plan, arr)                                    gamer_fftw::mpi_execute_dft_c2c ( plan, 1,                   (gamer_fftw::complex*) arr, NULL, FFTW_TRANSPOSED_ORDER )
