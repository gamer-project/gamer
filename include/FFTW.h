...
#define gramfe_create_fftw_1d_forward_c2c_plan(size, arr)   gramfe_float_fftw3_plan_dft_c2c_1d(     size, (gramfe_float_fftw3_complex*) arr, (gramfe_float_fftw3_complex*) arr, FFTW_FORWARD , FFTW_MEASURE )
#define gramfe_create_fftw_1d_backward_c2c_plan(size, arr)  gramfe_float_fftw3_plan_dft_c2c_1d(     size, (gramfe_float_fftw3_complex*) arr, (gramfe_float_fftw3_complex*) arr, FFTW_BACKWARD, FFTW_MEASURE )
...
#define gramfe_create_fftw_1d_forward_c2c_plan(size, arr)   fftw_create_plan( size, FFTW_FORWARD , FFTW_MEASURE | FFTW_IN_PLACE )
#define gramfe_create_fftw_1d_backward_c2c_plan(size, arr)  fftw_create_plan( size, FFTW_BACKWARD, FFTW_MEASURE | FFTW_IN_PLACE )
