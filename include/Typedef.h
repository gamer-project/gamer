...
const TestProbID_t
   ...
   TESTPROB_HYDRO_CONDUCTION_STEP_FUNCTION     =   24,
   TESTPROB_HYDRO_CONDUCTION_RING              =   25,
   TESTPROB_HYDRO_MHD_MTI                      =   26,
   TESTPROB_HYDRO_VELOCITY_PROFILE_DAMPING     =   27,
   TESTPROB_HYDRO_MHD_LINEAR_WAVE_VISCOSITY    =   28,
   TESTPROB_HYDRO_MHD_CPAW                     =   29,
