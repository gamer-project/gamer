...
extern int        INIT_DUMPID, INIT_SUBSAMPLING_NCELL, OPT__TIMING_BARRIER;
extern double     OUTPUT_PART_X, OUTPUT_PART_Y, OUTPUT_PART_Z;
extern double     OPT__CK_MEMFREE, INT_MONO_COEFF;
extern bool       OPT__FLAG_RHO, OPT__FLAG_RHO_GRADIENT, OPT__FLAG_USER, OPT__FLAG_LOHNER_DENS, OPT__FLAG_REGION;
extern bool       OPT__DT_USER, OPT__RECORD_DT, OPT__RECORD_MEMORY, OPT__ADAPTIVE_DT, OPT__REUSE_MEMORY, OPT__MEMORY_POOL;
extern bool       OPT__FIXUP_RESTRICT, OPT__INIT_RESTRICT, OPT__VERBOSE, OPT__MANUAL_CONTROL;
...
extern bool            OPT__OUTPUT_PAR_TEXT, OPT__CK_PARTICLE, OPT__FLAG_NPAR_CELL;
...
extern real       (*h_Flux_Array[2])[9][NFLUX][4*PATCH_SIZE*PATCH_SIZE];
