...
//                MinPres/Temp   : Minimum allowed pressure and temperature
...
void CUAPI_Asyn_dtSolver( const Solver_t TSolver, real h_dt_Array[], const real h_Flu_Array[][FLU_NIN_T][ CUBE(PS1) ],
                          ...
                          const MicroPhy_t MicroPhy, const real MinPres, const real MinTemp, const bool P5_Gradient, const bool UsePot,
         ...
         case DT_FLU_SOLVER:
            CUFLU_dtSolver_HydroCFL <<< NPatch_per_Stream[s], BlockDim_dtSolver, 0, Stream[s] >>>
                                    ( d_dt_Array_T  + UsedPatch[s],
                                      ...
                                      dh, Safety, MinPres, MinTemp, EoS, MicroPhy );
         break;
