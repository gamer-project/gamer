...
// Description :  Send the hierarchy information and data of local patches to libyt in patch.
//
...
// record local grids index and patched grids index
   int LID = 0;
   int LID_Patch = 0;
...
#            endif
                YT_Grids[LID_Patch].parent_id = -1;
             }
