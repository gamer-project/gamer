...
#     ifdef CHECK_UNPHYSICAL_IN_FLUID
      ...
      Hydro_CheckUnphysical( NULL, NULL, &L_star[0], NULL, "density", __FILE__, __FUNCTION__, __LINE__, true );
#     endif
...
#     ifdef CHECK_UNPHYSICAL_IN_FLUID
      ...
      Hydro_CheckUnphysical( NULL, NULL, &R_star[0], NULL, "density", __FILE__, __FUNCTION__, __LINE__, true );
#     endif
