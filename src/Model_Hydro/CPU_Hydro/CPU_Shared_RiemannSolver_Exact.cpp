...
#     ifdef CHECK_UNPHYSICAL_IN_FLUID
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &L[4]     , "pressure", __FILE__, __FUNCTION__, __LINE__, UNPHY_VERBOSE );
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &L[0]     , "density" , __FILE__, __FUNCTION__, __LINE__, UNPHY_VERBOSE );
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &L_star[4], "pressure", __FILE__, __FUNCTION__, __LINE__, UNPHY_VERBOSE );
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &L_star[0], "density" , __FILE__, __FUNCTION__, __LINE__, UNPHY_VERBOSE );
#     endif
...
#     ifdef CHECK_UNPHYSICAL_IN_FLUID
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &R[4]     , "pressure", __FILE__, __FUNCTION__, __LINE__, UNPHY_VERBOSE );
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &R[0]     , "density" , __FILE__, __FUNCTION__, __LINE__, UNPHY_VERBOSE );
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &R_star[4], "pressure", __FILE__, __FUNCTION__, __LINE__, UNPHY_VERBOSE );
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &R_star[0], "density" , __FILE__, __FUNCTION__, __LINE__, UNPHY_VERBOSE );
#     endif
...
#     ifdef CHECK_UNPHYSICAL_IN_FLUID
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &Temp, "value", __FILE__, __FUNCTION__, __LINE__, UNPHY_VERBOSE );
#     endif
...
#     ifdef CHECK_UNPHYSICAL_IN_FLUID
      ...
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &rho, "density" , __FILE__, __FUNCTION__, __LINE__, UNPHY_VERBOSE );
#     endif
