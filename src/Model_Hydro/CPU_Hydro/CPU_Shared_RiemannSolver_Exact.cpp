...
#     ifdef CHECK_UNPHYSICAL_IN_FLUID
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &L[4],      "pressure",
                             (real)0.0,   HUGE_NUMBER, NULL_REAL, NULL, NULL, NULL, NULL, NULL, NULL,
                             ERROR_INFO, UNPHY_VERBOSE );
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &L[0],      "density",
                             TINY_NUMBER, HUGE_NUMBER, NULL_REAL, NULL, NULL, NULL, NULL, NULL, NULL,
                             ERROR_INFO, UNPHY_VERBOSE );
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &L_star[4], "pressure",
                             (real)0.0,   HUGE_NUMBER, NULL_REAL, NULL, NULL, NULL, NULL, NULL, NULL,
                             ERROR_INFO, UNPHY_VERBOSE );
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &L_star[0], "density",
                             TINY_NUMBER, HUGE_NUMBER, NULL_REAL, NULL, NULL, NULL, NULL, NULL, NULL,
                             ERROR_INFO, UNPHY_VERBOSE );
#     endif
...
#     ifdef CHECK_UNPHYSICAL_IN_FLUID
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &R[4],      "pressure",
                             (real)0.0,   HUGE_NUMBER, NULL_REAL, NULL, NULL, NULL, NULL, NULL, NULL,
                             ERROR_INFO, UNPHY_VERBOSE );
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &R[0],      "density",
                             TINY_NUMBER, HUGE_NUMBER, NULL_REAL, NULL, NULL, NULL, NULL, NULL, NULL,
                             ERROR_INFO, UNPHY_VERBOSE );
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &R_star[4], "pressure",
                             (real)0.0,   HUGE_NUMBER, NULL_REAL, NULL, NULL, NULL, NULL, NULL, NULL,
                             ERROR_INFO, UNPHY_VERBOSE );
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &R_star[0], "density",
                             TINY_NUMBER, HUGE_NUMBER, NULL_REAL, NULL, NULL, NULL, NULL, NULL, NULL,
                             ERROR_INFO, UNPHY_VERBOSE );
#     endif
...
#     ifdef CHECK_UNPHYSICAL_IN_FLUID
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &Temp, "value",
                             (real)0.0, HUGE_NUMBER, NULL_REAL, NULL, NULL, NULL, NULL, NULL, NULL,
                             ERROR_INFO, UNPHY_VERBOSE );
#     endif
...
#     endif
   ...
   {
#     ifdef CHECK_UNPHYSICAL_IN_FLUID
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &p,   "pressure",
                             (real)0.0,   HUGE_NUMBER, NULL_REAL, NULL, NULL, NULL, NULL, NULL, NULL,
                             ERROR_INFO, UNPHY_VERBOSE );
      Hydro_CheckUnphysical( UNPHY_MODE_SING, &rho, "density",
                             TINY_NUMBER, HUGE_NUMBER, NULL_REAL, NULL, NULL, NULL, NULL, NULL, NULL,
                             ERROR_INFO, UNPHY_VERBOSE );
#     endif
