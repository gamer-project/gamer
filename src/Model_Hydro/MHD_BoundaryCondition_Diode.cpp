...
static void BC_Diode_xm( real **Array, const int NVar, const int TVarIdxList[], const int GhostSize, const int ArraySizeX, const int ArraySizeY,
                         const int ArraySizeZ, const int Idx_Start[], const int Idx_End[] );
static void BC_Diode_xp( real **Array, const int NVar, const int TVarIdxList[], const int GhostSize, const int ArraySizeX, const int ArraySizeY,
                         const int ArraySizeZ, const int Idx_Start[], const int Idx_End[] );
static void BC_Diode_ym( real **Array, const int NVar, const int TVarIdxList[], const int GhostSize, const int ArraySizeX, const int ArraySizeY,
                         const int ArraySizeZ, const int Idx_Start[], const int Idx_End[] );
static void BC_Diode_yp( real **Array, const int NVar, const int TVarIdxList[], const int GhostSize, const int ArraySizeX, const int ArraySizeY,
                         const int ArraySizeZ, const int Idx_Start[], const int Idx_End[] );
static void BC_Diode_zm( real **Array, const int NVar, const int TVarIdxList[], const int GhostSize, const int ArraySizeX, const int ArraySizeY,
                         const int ArraySizeZ, const int Idx_Start[], const int Idx_End[] );
static void BC_Diode_zp( real **Array, const int NVar, const int TVarIdxList[], const int GhostSize, const int ArraySizeX, const int ArraySizeY,
                         const int ArraySizeZ, const int Idx_Start[], const int Idx_End[] );
...
// set the boundary values at different boundary faces
   switch ( BC_Face )
   {
      case 0:  BC_Diode_xm( Array, NVar, TVarIdxList, GhostSize, ArraySizeX, ArraySizeY, ArraySizeZ, Idx_Start, Idx_End );  break;
      case 1:  BC_Diode_xp( Array, NVar, TVarIdxList, GhostSize, ArraySizeX, ArraySizeY, ArraySizeZ, Idx_Start, Idx_End );  break;
      case 2:  BC_Diode_ym( Array, NVar, TVarIdxList, GhostSize, ArraySizeX, ArraySizeY, ArraySizeZ, Idx_Start, Idx_End );  break;
      case 3:  BC_Diode_yp( Array, NVar, TVarIdxList, GhostSize, ArraySizeX, ArraySizeY, ArraySizeZ, Idx_Start, Idx_End );  break;
      case 4:  BC_Diode_zm( Array, NVar, TVarIdxList, GhostSize, ArraySizeX, ArraySizeY, ArraySizeZ, Idx_Start, Idx_End );  break;
      case 5:  BC_Diode_zp( Array, NVar, TVarIdxList, GhostSize, ArraySizeX, ArraySizeY, ArraySizeZ, Idx_Start, Idx_End );  break;
      default: Aux_Error( ERROR_INFO, "incorrect boundary face (%d) !!\n", BC_Face );
   }
...
//
// Note        :  Work for MHD_BoundaryCondition_Diode()
//
// Parameter   :  See MHD_BoundaryCondition_Diode()
//
// Return      :  Array
//-------------------------------------------------------------------------------------------------------
void BC_Diode_xm( real **Array, const int NVar, const int TVarIdxList[], const int GhostSize, const int ArraySizeX, const int ArraySizeY,
                  const int ArraySizeZ, const int Idx_Start[], const int Idx_End[] )
{
      ...
      switch ( TVarIdxList[v] )
      {
         case MAGX:
         {
            ...
            for (int i=Idx_Start[0]; i<=Idx_End[0]; i++)
               MagX[k][j][i] = MIN(MagX[k][j][i_ref_n-i], 0.0);
...
// Return      :  Array
//-------------------------------------------------------------------------------------------------------
void BC_Diode_xp( real **Array, const int NVar, const int TVarIdxList[], const int GhostSize, const int ArraySizeX, const int ArraySizeY,
                  const int ArraySizeZ, const int Idx_Start[], const int Idx_End[] )
{
      ...
      switch ( TVarIdxList[v] )
      {
         case MAGX:
         {
            ...
            for (int i=Idx_Start[0]+1; i<=Idx_End[0]+1; i++)
               MagX[k][j][i] = MAX(MagX[k][j][i_ref_n-i], 0.0);
...
// Return      :  Array
//-------------------------------------------------------------------------------------------------------
void BC_Diode_ym( real **Array, const int NVar, const int TVarIdxList[], const int GhostSize, const int ArraySizeX, const int ArraySizeY,
                  const int ArraySizeZ, const int Idx_Start[], const int Idx_End[] )
{
   ...
   for (int v=0; v<NVar; v++)
   {
      switch ( TVarIdxList[v] )
      {
         ...
         case MAGY:
         {
            ...
            for (int j=Idx_Start[1]; j<=Idx_End[1]; j++)
            for (int i=Idx_Start[0]; i<=Idx_End[0]; i++)
               MagY[k][j][i] = MIN(MagY[k][j_ref_n-j][i], 0.0);
...
// Return      :  Array
//-------------------------------------------------------------------------------------------------------
void BC_Diode_yp( real **Array, const int NVar, const int TVarIdxList[], const int GhostSize, const int ArraySizeX, const int ArraySizeY,
                  const int ArraySizeZ, const int Idx_Start[], const int Idx_End[] )
{
   ...
   for (int v=0; v<NVar; v++)
   {
      switch ( TVarIdxList[v] )
      {
         ...
         case MAGY:
         {
            ...
            for (int i=Idx_Start[0];   i<=Idx_End[0];   i++)
               MagY[k][j][i] = MAX(MagY[k][j_ref_n-j][i], 0.0);
...
// Return      :  Array
//-------------------------------------------------------------------------------------------------------
void BC_Diode_zm( real **Array, const int NVar, const int TVarIdxList[], const int GhostSize, const int ArraySizeX, const int ArraySizeY,
                  const int ArraySizeZ, const int Idx_Start[], const int Idx_End[] )
{
   ...
   for (int v=0; v<NVar; v++)
   {
      switch ( TVarIdxList[v] )
      {
         ...
         case MAGZ:
         {
            ...
            for (int j=Idx_Start[1]; j<=Idx_End[1]; j++)
            for (int i=Idx_Start[0]; i<=Idx_End[0]; i++)
               MagZ[k][j][i] = MIN(MagZ[k_ref_n-k][j][i], 0.0);
...
// Return      :  Array
//-------------------------------------------------------------------------------------------------------
void BC_Diode_zp( real **Array, const int NVar, const int TVarIdxList[], const int GhostSize, const int ArraySizeX, const int ArraySizeY,
                  const int ArraySizeZ, const int Idx_Start[], const int Idx_End[] )
{
   ...
   for (int v=0; v<NVar; v++)
   {
      switch ( TVarIdxList[v] )
      {
         ...
         case MAGZ:
         {
            ...
            for (int j=Idx_Start[1];   j<=Idx_End[1];   j++)
            for (int i=Idx_Start[0];   i<=Idx_End[0];   i++)
               MagZ[k][j][i] = MAX(MagZ[k_ref_n-k][j][i], 0.0);
