...
#  elif ( MODEL == SR_HYDRO )
   const int NVar_NoPassive       = 5;    // 8: mass, momentum (x/y/z), total energies
...
#        elif   ( MODEL == SR_HYDRO )
         Aux_Message( File, "# Mass_Gas     : total SR_HYDRO mass\n" );
         Aux_Message( File, "# MomX/Y/Z_Gas : total SR_HYDRO momentum\n" );
         Aux_Message( File, "# Etot_Gas     : total SR_HYDRO total energy\n" );
