...
// ------------------------------
   ...
   {
      Aux_Message( stderr, "WARNING : SF_CREATE_STAR_SCHEME == %d or %d will break bitwise reproducibility due to the\n", SF_CREATE_STAR_SCHEME_AGORA, SF_CREATE_STAR_SCHEME_DWARFGALAXY );
