...
//          --> note that the order of which thread calls RemoveOneParticle first is undetermined and may change from run to run
...
//          --> but it's not an issue since the actual data of each particle will not affected
#           pragma omp critical
