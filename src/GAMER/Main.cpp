...
int               INIT_DUMPID, INIT_SUBSAMPLING_NCELL, OPT__TIMING_BARRIER;
bool              OPT__FLAG_RHO, OPT__FLAG_RHO_GRADIENT, OPT__FLAG_USER, OPT__FLAG_LOHNER_DENS, OPT__FLAG_REGION;
bool              OPT__DT_USER, OPT__RECORD_DT, OPT__RECORD_MEMORY, OPT__ADAPTIVE_DT, OPT__REUSE_MEMORY, OPT__MEMORY_POOL;
