...
#  endif
   ...
   // detect MPI ranks per node and give warning message if necessary (assume all nodes have the same MPI ranks per node); reference: https://stackoverflow.com/questions/9022496/how-to-determine-mpi-rank-process-number-local-to-a-socket-node
   int MPI_SizePerNode;
   MPI_Comm shmcomm;
