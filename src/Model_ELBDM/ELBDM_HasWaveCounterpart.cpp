...
// during first iteration, cover the eight patches in the patch group
// pretend that patches in patch group are children of a common father even at level 0
// set currentLv = 0 in loop and iterate over patch group
// once patch containing coordinate is found, iterate over that patch's children
