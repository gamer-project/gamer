...
//-------------------------------------------------------------------------------------------------------
// Function    :  SetExtPotAuxArray_GC
// Description :  Set the auxiliary arrays ExtPot_AuxArray_Flt/Int[] used by ExtPot_GC()
//
// Note        :  1. Invoked by Init_ExtPot_GC()
...
//-------------------------------------------------------------------------------------------------------
void SetExtPotAuxArray_GC( double AuxArray_Flt[], int AuxArray_Int[], const double Time )
{
   double GC_Rho0 = 1.0;
   double GC_R0   = 0.1;
...
//                2. Auxiliary arrays UserArray_Flt/Int[] are set by SetExtPotAuxArray_GC()
...
//-----------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real ExtPot_GC( const double x, const double y, const double z, const double Time,
...
FUNC_SPACE ExtPot_t ExtPot_Ptr = ExtPot_GC;

//-----------------------------------------------------------------------------------------
// Function    :  SetCPU/GPUExtPot_GC
...
#ifdef __CUDACC__
__host__
void SetGPUExtPot_GC( ExtPot_t &GPUExtPot_Ptr )
{
...
void SetCPUExtPot_GC( ExtPot_t &CPUExtPot_Ptr )
{
...
void SetExtPotAuxArray_GC( double [], int [], const double );
void SetCPUExtPot_GC( ExtPot_t & );
#ifdef GPU
void SetGPUExtPot_GC( ExtPot_t & );
#endif

//-----------------------------------------------------------------------------------------
// Function    :  Init_ExtPot_GC
...
void Init_ExtPot_GC()
{
   ...
   SetExtPotAuxArray_GC( ExtPot_AuxArray_Flt, ExtPot_AuxArray_Int, Time[0] );
   SetCPUExtPot_GC( CPUExtPot_Ptr );
#  ifdef GPU
   SetGPUExtPot_GC( GPUExtPot_Ptr );
#  endif
