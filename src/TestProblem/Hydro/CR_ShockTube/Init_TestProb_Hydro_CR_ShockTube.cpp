...
// ********************************************************************************************************************************
   AddInputTestPara( load_mode, "CR_Shocktube_Rho_R",    &CR_Shocktube_Rho_R,        0.0,           0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "CR_Shocktube_Rho_L",    &CR_Shocktube_Rho_L,        0.0,           0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "CR_Shocktube_Pres_R",   &CR_Shocktube_Pres_R,       0.0,           0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "CR_Shocktube_Pres_L",   &CR_Shocktube_Pres_L,       0.0,           0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "CR_Shocktube_PresCR_R", &CR_Shocktube_PresCR_R,     0.0,           0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "CR_Shocktube_PresCR_L", &CR_Shocktube_PresCR_L,     0.0,           0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "CR_Shocktube_Dir",      &CR_Shocktube_Dir,          0,             0,                2                 );
