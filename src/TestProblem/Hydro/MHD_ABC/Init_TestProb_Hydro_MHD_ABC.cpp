...
// ********************************************************************************************************************************
   AddInputTestPara( load_mode, "ABC_Rho0",          &ABC_Rho0,              1.0,           Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "ABC_P0",            &ABC_P0,                1.0,           Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "ABC_V0",            &ABC_V0,                0.0,           NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "ABC_CoeffA",        &ABC_CoeffA,            1.0,           NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "ABC_CoeffB",        &ABC_CoeffB,            1.0,           NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "ABC_CoeffC",        &ABC_CoeffC,            1.0,           NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "ABC_NPeriod",       &ABC_NPeriod,           1,             1,                NoMax_int         );
