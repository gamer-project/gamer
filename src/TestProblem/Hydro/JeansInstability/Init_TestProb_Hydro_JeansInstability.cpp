...
// ************************************************************************************************************************
   LOAD_PARA( load_mode, "Jeans_Rho0",        &Jeans_Rho0,           -1.0,           Eps_double,       NoMax_double      );
   LOAD_PARA( load_mode, "Jeans_Rho1",        &Jeans_Rho1,           -1.0,           0.0,              NoMax_double      );
   LOAD_PARA( load_mode, "Jeans_P0",          &Jeans_P0,             -1.0,           Eps_double,       NoMax_double      );
   LOAD_PARA( load_mode, "Jeans_v0",          &Jeans_v0,              0.0,           NoMin_double,     NoMax_double      );
   LOAD_PARA( load_mode, "Jeans_Dir",         &Jeans_Dir,             3,             0,                3                 );
   LOAD_PARA( load_mode, "Jeans_Sign",        &Jeans_Sign,            1.0,           NoMin_double,     NoMax_double      );
   LOAD_PARA( load_mode, "Jeans_Phase0",      &Jeans_Phase0,          0.0,           NoMin_double,     NoMax_double      );
#  ifdef MHD
   LOAD_PARA( load_mode, "Jeans_B0",          &Jeans_B0,             -1.0,           0.0,              NoMax_double      );
#  endif
