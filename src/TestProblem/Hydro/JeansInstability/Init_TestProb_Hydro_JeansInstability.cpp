...
void Output_HDF5_TestProb( HDF5_Output_t *HDF5_InputTest )
{
   ...
   HDF5_InputTest->Add( "Jeans_Rho0",   &Jeans_Rho0   );
   HDF5_InputTest->Add( "Jeans_Rho1",   &Jeans_Rho1   );
   HDF5_InputTest->Add( "Jeans_P0",     &Jeans_P0     );
   HDF5_InputTest->Add( "Jeans_v0",     &Jeans_v0     );
   HDF5_InputTest->Add( "Jeans_Dir",    &Jeans_Dir    );
   HDF5_InputTest->Add( "Jeans_Sign",   &Jeans_Sign   );
   HDF5_InputTest->Add( "Jeans_Phase0", &Jeans_Phase0 );
#  ifdef MHD
   HDF5_InputTest->Add( "Jeans_B0",     &Jeans_B0     );
#  endif
