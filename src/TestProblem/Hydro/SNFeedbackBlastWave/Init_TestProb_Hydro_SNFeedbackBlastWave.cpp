...
// ********************************************************************************************************************************
   ReadPara->Add( "SNBlast_Dens_Bg",          &SNBlast_Dens_Bg,           1.0e-22,      Eps_double,       NoMax_double      );
   ReadPara->Add( "SNBlast_Temp_Bg",          &SNBlast_Temp_Bg,           1.0e+01,      Eps_double,       NoMax_double      );
   ReadPara->Add( "SNBlast_MetalMassFrac_Bg", &SNBlast_MetalMassFrac_Bg,  0.0,          0.0,              1.0               );
   ReadPara->Add( "SNBlast_ParMass",          &SNBlast_ParMass,           1.0e+02,      Eps_double,       NoMax_double      );
   ReadPara->Add( "SNBlast_ParCenter_X",      &SNBlast_ParCenter[0],     -1.0,          NoMin_double,     amr->BoxSize[0]   );
   ReadPara->Add( "SNBlast_ParCenter_Y",      &SNBlast_ParCenter[1],     -1.0,          NoMin_double,     amr->BoxSize[1]   );
   ReadPara->Add( "SNBlast_ParCenter_Z",      &SNBlast_ParCenter[2],     -1.0,          NoMin_double,     amr->BoxSize[2]   );
   ReadPara->Add( "SNBlast_ParVelocity_X",    &SNBlast_ParVelocity[0],    0.0,          NoMin_double,     NoMax_double      );
   ReadPara->Add( "SNBlast_ParVelocity_Y",    &SNBlast_ParVelocity[1],    0.0,          NoMin_double,     NoMax_double      );
   ReadPara->Add( "SNBlast_ParVelocity_Z",    &SNBlast_ParVelocity[2],    0.0,          NoMin_double,     NoMax_double      );
   ReadPara->Add( "SNBlast_ParMetalMassFrac", &SNBlast_ParMetalMassFrac,  0.0,          0.0,              1.0               );
