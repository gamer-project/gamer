...
// ********************************************************************************************************************************
   AddInputTestPara( load_mode, "Gas_Par_Setup",     &Gas_Par_Setup,          1,            1,                2                 );
   AddInputTestPara( load_mode, "n_Pert_Wave_Len",   &n_Pert_Wave_Len,        1,            1,                NoMax_int         );
   AddInputTestPara( load_mode, "z_Collapse",        &z_Collapse,             1.0,          0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "GasTemp_Init",      &GasTemp_Init,           100.0,        0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "NPar_X",            &NPar_X,                 NX0_TOT[0],   0,                NoMax_int         );
