...
// ********************************************************************************************************************************
   AddInputTestPara( load_mode, "CR_Acoustic_Delta",    &CR_Acoustic_Delta,         0.0,           0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "CR_Acoustic_Rho0",     &CR_Acoustic_Rho0,          0.0,           0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "CR_Acoustic_Pres0",    &CR_Acoustic_Pres0,         0.0,           0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "CR_Acoustic_Pres_CR0", &CR_Acoustic_Pres_CR0,      0.0,           0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "CR_Acoustic_V0",       &CR_Acoustic_V0,            0.0,           NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "CR_Acoustic_Sign",     &CR_Acoustic_Sign,          0.0,           NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "CR_Acoustic_Phase",    &CR_Acoustic_Phase,         0.0,           NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "CR_Acoustic_Dir",      &CR_Acoustic_Dir,           0,             0,                3                 );
