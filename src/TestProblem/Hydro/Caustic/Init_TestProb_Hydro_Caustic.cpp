...
// ************************************************************************************************************************
   LOAD_PARA( load_mode, "Caustic_VelPeak",   &Caustic_VelPeak,       -1.0,          Eps_double,       NoMax_double      );
   LOAD_PARA( load_mode, "Caustic_Dens",      &Caustic_Dens,          -1.0,          Eps_double,       NoMax_double      );
