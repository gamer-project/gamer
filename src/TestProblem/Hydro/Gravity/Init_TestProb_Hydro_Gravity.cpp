...
// ************************************************************************************************************************
   LOAD_PARA( load_mode, "Gra_DensProf",      &Gra_DensProf,          2,             1,                2                 );
   LOAD_PARA( load_mode, "Gra_Radius0",       &Gra_Radius0,           1.0,           Eps_double,       NoMax_double      );
   LOAD_PARA( load_mode, "Gra_Dens0",         &Gra_Dens0,             1.0,           Eps_double,       NoMax_double      );
