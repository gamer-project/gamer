...
// =======================================================================================
static double Turb_Rho0;       // density
static double Turb_P0;         // pressure
static double Turb_B0;         // magnetic field along the z direction
// =======================================================================================
...
// ************************************************************************************************************************
   LOAD_PARA( load_mode, "Turb_Rho0",          &Turb_Rho0,              1.0,           Eps_double,       NoMax_double      );
   LOAD_PARA( load_mode, "Turb_P0",            &Turb_P0,                1.0,           Eps_double,       NoMax_double      );
   LOAD_PARA( load_mode, "Turb_B0",            &Turb_B0,                1.0e-4,        NoMin_double,     NoMax_double      );
...
// (4) make a note
   if ( MPI_Rank == 0 )
   {
      ...
      Aux_Message( stdout, "  background Bz       = %14.7e\n", Turb_B0      );
      Aux_Message( stdout, "=============================================================================\n" );
   }
...
//-------------------------------------------------------------------------------------------------------
// Function    :  Init_TestProb_Hydro_Turbulence
...
// Return      :  None
//-------------------------------------------------------------------------------------------------------
void Init_TestProb_Hydro_Turbulence()
{
