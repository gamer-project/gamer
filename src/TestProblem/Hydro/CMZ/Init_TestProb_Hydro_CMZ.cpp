...
// ********************************************************************************************************************************
   AddInputTestPara( load_mode, "BarredPot_V0",         &BarredPot_V0,          200.,          Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "BarredPot_q" ,         &BarredPot_q ,          0.9 ,          Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "BarredPot_Rc",         &BarredPot_Rc,          0.05,          Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "BarredPot_Omegabar",   &BarredPot_Omegabar,    40. ,          Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "BarredPot_fullBS"  ,   &BarredPot_fullBS,      0.1 ,          Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "BarredPot_initT"   ,   &BarredPot_initT,       1.0e4,         Eps_double,       NoMax_double      );
