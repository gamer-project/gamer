...
// =======================================================================================
static double VPD_Rho0;          // background density
static double VPD_P0;            // background pressure
...
// ****************************************************************************************************************
   LOAD_PARA( load_mode, "VPD_Rho0",         &VPD_Rho0,        1.0,          Eps_double,       NoMax_double      );
   LOAD_PARA( load_mode, "VPD_P0",           &VPD_P0,          1.0,          Eps_double,       NoMax_double      );
   LOAD_PARA( load_mode, "VPD_v0",           &VPD_v0,          1.0,          NoMin_double,     NoMax_double      );
   LOAD_PARA( load_mode, "VPD_Dir",          &VPD_Dir,         0,            0,                3                 );
   LOAD_PARA( load_mode, "VPD_B0",           &VPD_B0,          1.0,          0.0,              NoMax_double      );
   LOAD_PARA( load_mode, "VPD_BDir",         &VPD_BDir,        0,            0,                3                 );
...
static void OutputError()
{
   ...
   const char Prefix[100]     = "VelocityProfileDamping";
   const OptOutputPart_t Part = OUTPUT_X + VPD_Dir;
...
//-------------------------------------------------------------------------------------------------------
// Function    :  Init_TestProb_Hydro_VelocityProfileDamping
