...
#  ifdef MHD
   ReadPara->Add( "Blast_BField_X",       &Blast_BField_X,         0.0288675,    NoMin_double,     NoMax_double      );
   ReadPara->Add( "Blast_BField_Y",       &Blast_BField_Y,         0.0288675,    NoMin_double,     NoMax_double      );
   ReadPara->Add( "Blast_BField_Z",       &Blast_BField_Z,         0.0288675,    NoMin_double,     NoMax_double      );
