...
// ********************************************************************************************************************************
   ReadPara->Add( "MHDLinearVisc_Mode",    &MHDLinearVisc_Mode,        -1,            1,                1                 );
   ...
   ReadPara->Add( "MHDLinearVisc_Dir",     &MHDLinearVisc_Dir,          3,            0,                3                 );
   ReadPara->Add( "MHDLinearVisc_B0",      &MHDLinearVisc_B0,          -1.0,          0.0,              NoMax_double      );
