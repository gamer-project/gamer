...
// ********************************************************************************************************************************
   AddInputTestPara( load_mode, "ParTest_Dens_Bg",     &ParTest_Dens_Bg,        1.0e-2,       Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "ParTest_Pres_Bg",     &ParTest_Pres_Bg,        1.0e-2,       Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "ParTest_Ang_Freq",    &ParTest_Ang_Freq,       0.00051668,   Eps_double,       1.0e-3            );
   AddInputTestPara( load_mode, "ParTest_NParX",       &ParTest_NPar[0],        32,           2,                128               );
   AddInputTestPara( load_mode, "ParTest_NParY",       &ParTest_NPar[1],        32,           2,                128               );
   AddInputTestPara( load_mode, "ParTest_NParZ",       &ParTest_NPar[2],        32,           2,                128               );
   AddInputTestPara( load_mode, "ParTest_Par_Sep",     &ParTest_Par_Sep,        0.5,          Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "ParTest_Point_Mass",  &ParTest_Point_Mass,     1.0,          Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "ParTest_Use_Tracers", &ParTest_Use_Tracers,    true,         Useless_bool,     Useless_bool      );
   AddInputTestPara( load_mode, "ParTest_Use_Massive", &ParTest_Use_Massive,    true,         Useless_bool,     Useless_bool      );
