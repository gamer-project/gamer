...
// ******************************************************************************************************************************
   LOAD_PARA( load_mode, "OrszagTang_Rho0",   &OrszagTang_Rho0,       25.0/(36.0*M_PI),    Eps_double,       NoMax_double      );
   LOAD_PARA( load_mode, "OrszagTang_P0",     &OrszagTang_P0,          5.0/(12.0*M_PI),    Eps_double,       NoMax_double      );
   LOAD_PARA( load_mode, "OrszagTang_Vx0",    &OrszagTang_Vx0,        -1.0,                NoMin_double,     NoMax_double      );
