...
// ********************************************************************************************************************************
   AddInputTestPara( load_mode, "Acoustic_RhoAmp",   &Acoustic_RhoAmp,       -1.0,          Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "Acoustic_Dir",      &Acoustic_Dir,           3,            0,                3                 );
   AddInputTestPara( load_mode, "Acoustic_Sign",     &Acoustic_Sign,          1.0,          NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "Acoustic_Phase0",   &Acoustic_Phase0,        0.0,          NoMin_double,     NoMax_double      );
#  ifdef SRHD
   AddInputTestPara( load_mode, "Acoustic_Temp_Bg",  &Acoustic_Temp_Bg,       1.0,          Eps_double,       NoMax_double      );
#  else
   AddInputTestPara( load_mode, "Acoustic_v0",       &Acoustic_v0,            0.0,          NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "Acoustic_Cs",       &Acoustic_Cs,           -1.0,          Eps_double,       NoMax_double      );
#  endif
