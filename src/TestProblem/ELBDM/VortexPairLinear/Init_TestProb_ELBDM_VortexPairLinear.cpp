...
// ********************************************************************************************************************************
   AddInputTestPara( load_mode, "VorPairLin_BgAmp",     &VorPairLin_BgAmp,      1.0,           0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "VorPairLin_WaveAmp",   &VorPairLin_WaveAmp,   -1.0,           Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "VorPairLin_ZWaveAmp",  &VorPairLin_ZWaveAmp,   0.0,           0.0,              NoMax_double      );
   AddInputTestPara( load_mode, "VorPairLin_Phase0",    &VorPairLin_Phase0,     0.0,           NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "VorPairLin_kx",        &VorPairLin_kx,         1.0,           1.0,              NoMax_double      );
   AddInputTestPara( load_mode, "VorPairLin_ky",        &VorPairLin_ky,         1.0,           1.0,              NoMax_double      );
   AddInputTestPara( load_mode, "VorPairLin_kz",        &VorPairLin_kz,         1.0,           1.0,              NoMax_double      );
