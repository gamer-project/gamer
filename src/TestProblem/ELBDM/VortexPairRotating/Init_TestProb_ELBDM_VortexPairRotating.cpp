...
// ********************************************************************************************************************************
   AddInputTestPara( load_mode, "VorPairRot_BgAmp",  &VorPairRot_BgAmp,     -1.0,           Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "VorPairRot_J1Amp",  &VorPairRot_J1Amp,     -1.0,           Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "VorPairRot_Omega",  &VorPairRot_Omega,     -1.0,           Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "VorPairRot_Phase0", &VorPairRot_Phase0,     0.0,           NoMin_double,     NoMax_double      );
