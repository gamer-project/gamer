...
// ************************************************************************************************************************
   LOAD_PARA( load_mode, "VorPairRot_BgAmp",  &VorPairRot_BgAmp,     -1.0,           Eps_double,       NoMax_double      );
   LOAD_PARA( load_mode, "VorPairRot_J1Amp",  &VorPairRot_J1Amp,     -1.0,           Eps_double,       NoMax_double      );
