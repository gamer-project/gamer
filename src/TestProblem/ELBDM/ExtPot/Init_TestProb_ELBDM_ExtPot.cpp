...
// ********************************************************************************************************************************
   AddInputTestPara( load_mode, "ELBDM_ExtPot_Amp",     &ELBDM_ExtPot_Amp,      -1.0,          Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "ELBDM_ExtPot_M",       &ELBDM_ExtPot_M,        -1.0,          Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "ELBDM_ExtPot_Cen_X",   &ELBDM_ExtPot_Cen[0],   -1.0,          NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "ELBDM_ExtPot_Cen_Y",   &ELBDM_ExtPot_Cen[1],   -1.0,          NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "ELBDM_ExtPot_Cen_Z",   &ELBDM_ExtPot_Cen[2],   -1.0,          NoMin_double,     NoMax_double      );
