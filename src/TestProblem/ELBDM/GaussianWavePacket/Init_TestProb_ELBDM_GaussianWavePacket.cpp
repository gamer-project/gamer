...
// ********************************************************************************************************************************
   AddInputTestPara( load_mode, "Gau_v0",            &Gau_v0,                1.0,           NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "Gau_Width",         &Gau_Width,             0.1,           Eps_double,       NoMax_double      );
   AddInputTestPara( load_mode, "Gau_Center",        &Gau_Center,            NoDef_double,  NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "Gau_XYZ",           &Gau_XYZ,               0,             0,                2                 );
   AddInputTestPara( load_mode, "Gau_PeriodicN",     &Gau_PeriodicN,         0,             0,                NoMax_int         );
