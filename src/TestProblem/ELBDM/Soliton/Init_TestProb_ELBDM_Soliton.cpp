...
// ********************************************************************************************************************************
   AddInputTestPara( load_mode, "Soliton_N",                 &Soliton_N,                 -1,             1,                NoMax_int         );
   AddInputTestPara( load_mode, "Soliton_RSeed",             &Soliton_RSeed,              0,             NoMin_int,        NoMax_int         );
   AddInputTestPara( load_mode, "Soliton_CoreRadiusAll",     &Soliton_CoreRadiusAll,      NoDef_double,  NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "Soliton_EmptyRegion",       &Soliton_EmptyRegion,        0.0,           NoMin_double,     NoMax_double      );
   AddInputTestPara( load_mode, "Soliton_DensProf_Filename",  Soliton_DensProf_Filename,  NoDef_str,     Useless_str,      Useless_str       );
