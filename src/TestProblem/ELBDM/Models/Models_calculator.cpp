...
void Models_calculator::initialize_mass(int row_Models){
...
void Models_calculator::initialize_pot(int row_Models){
...
void Models_calculator::initialize_prob_dens(){
  double min =-Table_MassProf_pot_Models[row_Models-1],max =-Table_MassProf_pot_Models[1];
...
void Models_calculator::init(double newton_g,double rho,double r,int r_col,int rho_col,const char* Filename){
  ...
  initialize_mass(row_Models);
  initialize_pot(row_Models);
