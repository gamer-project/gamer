                ...
                const int lv, double AuxArray[] )
{
   ...
   const double real = 1.0 + Jeans_RealAmp( Jeans_RealAmp0, Jeans_y )*cos( Phase );
   const double imag =       Jeans_ImagAmp( Jeans_ImagAmp0, Jeans_y )*cos( Phase );
