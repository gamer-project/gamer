...
// ********************************************************************************************************************************
   AddInputTestPara( load_mode, "Perturbation_N",            &Perturbation_N,            -1,             1,                FOURIER_MODE_NUMBER  );
   AddInputTestPara( load_mode, "Perturbation_Amp",          &Perturbation_Amplitude,     NoDef_double,  NoMin_double,     NoMax_double         );
   AddInputTestPara( load_mode, "Perturbation_BgAmp",        &Perturbation_BgAmplitude,   NoDef_double,  NoMin_double,     NoMax_double         );
   AddInputTestPara( load_mode, "Perturbation_NDim",         &Perturbation_NDim,          3,             1,                3                    );
