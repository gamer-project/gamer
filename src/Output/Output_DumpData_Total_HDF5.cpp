...
//                2513 : 2026/09/16 --> output particle gravitational potential
//-------------------------------------------------------------------------------------------------------
...
#  ifdef PARTICLE
   ...
   InputPara.Opt__Output_Par_Pot     = OPT__OUTPUT_PAR_POT;
...
#  ifdef PARTICLE
   ...
   H5Tinsert( H5_TypeID, "Opt__Output_Par_Pot",     HOFFSET(InputPara_t,Opt__Output_Par_Pot    ), H5T_NATIVE_INT     );
