...
//                2506 : 2026/03/26 --> output Particle unique id
//-------------------------------------------------------------------------------------------------------
...
#  ifdef PARTICLE
   ...
   KeyInfo.Par_NextUID          = amr->Par->NextUID;
...
#  ifdef PARTICLE
   ...
   H5Tinsert( H5_TypeID, "Par_NextUID",          HOFFSET(KeyInfo_t,Par_NextUID         ), H5T_NATIVE_LONG         );
