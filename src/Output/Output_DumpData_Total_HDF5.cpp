...
// format version
// ----------------------------------------------------------------------------------------------------
   HDF5_KeyInfo->Add( "FormatVersion", 2505,            0, NULL, Compare_No, NULL_BOOL, NULL_BOOL );
...
#  endif
   ...
   HDF5_InputPara->Add( "PassiveFloor_Var",        &PassiveFloorMask,          0, NULL,      Compare_Yes, Fatal_No,  Fatal_No  );
