...
//
// Note        :  1. This function works for an arbitrary datatype (int, float, char, 1D array ...)
//                2. Memory must be allocated for FieldPtr in advance with a sufficient size (except for "char *")
