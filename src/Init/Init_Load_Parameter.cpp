...
#  if ( ELBDM_SCHEME == ELBDM_HYBRID )
   ...
   ReadPara->Add( "DT__HYBRID_FLUID",           &DT__HYBRID_FLUID,               -1.0,             NoMin_double,  NoMax_double   );
...
#  if ( MODEL == ELBDM )
   ...
   ReadPara->Add( "OPT__CK_PHASE_DEFECT",       &OPT__CK_PHASE_DEFECT,            false,           Useless_bool,  Useless_bool   );
#  if ( ELBDM_SCHEME == ELBDM_HYBRID )
