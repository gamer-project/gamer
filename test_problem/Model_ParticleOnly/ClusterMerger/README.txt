...
Note:
-------------------------------------------------------------------------------
1. Test the evolution of (1) a single galaxy cluster in hydrostatic equilibrium
                         (2) two merging clusters

2. The simple gnuplot scripts 'plot_*.gpt' can be used for visualization
