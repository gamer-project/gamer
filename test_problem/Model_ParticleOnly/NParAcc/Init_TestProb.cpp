...
static void Par_TestProbSol_NParAcc( real fluid[], const real x, const real y, const real z, const double Time );
...
// Return      :  fluid
//-------------------------------------------------------------------------------------------------------
void Par_TestProbSol_NParAcc( real *fluid, const real x, const real y, const real z, const double Time )
{
