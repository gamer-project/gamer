...
#  ./GAMER_SphereAnalysis -i $FILE_IN -o "$SUFFIX" -S -a 1 -r 0.30 -m 8 -a 1 -S -p -R 0.15 -c -x $x -y $y -z $z


#  example for setting all parameters manually
   ./GAMER_SphereAnalysis -i $FILE_IN -o "$SUFFIX" -S -a 1 -m 8 -p -r 0.10 -x 0.54 -y 0.64 -z 1.40
