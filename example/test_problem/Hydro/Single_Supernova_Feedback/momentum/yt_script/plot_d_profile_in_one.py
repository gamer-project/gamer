...
ax.plot( array_GAMER_r_4, array_GAMER_dens_4, c=plt.cm.autumn_r( 0.46 ), linewidth=2, label='t = 4.5 Myr', zorder=2.5 )
ax.plot( array_GAMER_r_5, array_GAMER_dens_5, c=plt.cm.autumn_r( 0.28 ), linewidth=2, label='t = 4.9 Myr', zorder=2.5 )
...
# save the figure
plt.tight_layout()
fig.savefig( 'density_profiles_all_time_momentum.pdf' )
