...
#load data
ts_1 = yt.load( prefix_1 + "/Data_000400" )
ts_2 = yt.load( prefix_1 + "/Data_000410" )
ts_3 = yt.load( prefix_1 + "/Data_000450" )
ts_4 = yt.load( prefix_1 + "/Data_000500" )
ts_5 = yt.load( prefix_1 + "/Data_000550" )
...
ax.plot( array_GAMER_r_2, array_GAMER_dens_2, c=plt.cm.autumn_r( 0.82 ), linewidth=2, label='t = 4.1 Myr', zorder=2.5 )
ax.plot( array_GAMER_r_3, array_GAMER_dens_3, c=plt.cm.autumn_r( 0.64 ), linewidth=2, label='t = 4.5 Myr', zorder=2.5 )
ax.plot( array_GAMER_r_4, array_GAMER_dens_4, c=plt.cm.autumn_r( 0.46 ), linewidth=2, label='t = 5.0 Myr', zorder=2.5 )
ax.plot( array_GAMER_r_5, array_GAMER_dens_5, c=plt.cm.autumn_r( 0.28 ), linewidth=2, label='t = 5.5 Myr', zorder=2.5 )
...
# save the figure
plt.tight_layout()
fig.savefig( 'density_profiles_all_time_energy.pdf' )
