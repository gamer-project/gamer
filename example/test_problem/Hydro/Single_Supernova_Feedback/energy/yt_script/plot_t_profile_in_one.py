...
ax.plot( array_GAMER_r_2, array_GAMER_temp_2, c=plt.cm.autumn_r( 0.82 ), linewidth=2, label='t = 4.1 Myr', zorder=2.5 )
ax.plot( array_GAMER_r_3, array_GAMER_temp_3, c=plt.cm.autumn_r( 0.64 ), linewidth=2, label='t = 4.5 Myr', zorder=2.5 )
ax.plot( array_GAMER_r_4, array_GAMER_temp_4, c=plt.cm.autumn_r( 0.46 ), linewidth=2, label='t = 5.0 Myr', zorder=2.5 )
ax.plot( array_GAMER_r_5, array_GAMER_temp_5, c=plt.cm.autumn_r( 0.28 ), linewidth=2, label='t = 5.5 Myr', zorder=2.5 )
