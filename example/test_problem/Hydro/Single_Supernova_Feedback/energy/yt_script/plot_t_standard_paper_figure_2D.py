...
###################################################################################################
n_rows             = 1                 # number of rows in the figure panels
...
fig_size_y         = (fig_size_x-1.6*cm)/n_cols*n_rows
...
Data_path[0] = '../Data_000400'
Data_path[1] = '../Data_000450'
Data_path[2] = '../Data_000500'
Data_path[3] = '../Data_000550'
...
def main() -> None:
    ...
    for panel_idx in range(0, n_rows*n_cols, 1):
        ...
        proj.set_colorbar_label( field_toplot, UNIT_T_todisplay )
    ...
    fig.savefig( "fig_standard_paper_figure_2D_t_energy.png", dpi=dpi )
    fig.savefig( "fig_standard_paper_figure_2D_t_energy.pdf", dpi=dpi )
