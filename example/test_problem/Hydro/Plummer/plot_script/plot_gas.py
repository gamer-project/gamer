...
for ds in ts.piter():
   ...
   pz_dens.set_unit( 'density', 'code_mass/code_length**2' )
...
#  pz_Cloud0.set_axes_unit( 'code_length' )
#  pz_Cloud0.set_unit( 'Pasive00', 'code_mass/code_length**2' )
#  pz_Cloud0.annotate_timestamp( time_unit='code_time', corner='upper_right' )
...
#  pz_Cloud1.set_axes_unit( 'code_length' )
#  pz_Cloud1.set_unit( 'Pasive01', 'code_mass/code_length**2' )
#  pz_Cloud1.annotate_timestamp( time_unit='code_time', corner='upper_right' )
