...
anal      = np.loadtxt("ReferenceSolution/TM_EoS/SRHD_Mixed")
...
ax[2].plot(    X_ANAL, UX_ANAL,            color='C3',                         label="Analytical" )
ax[2].scatter( X,      UX,           s=15, facecolors='none', edgecolors='C0', label="Simulation" )
ax[2].set(xscale='log')
ax[2].set(ylabel=r"$U_x/c$")
ax[2].set(xlabel=r"$x$")
ax[2].legend()
