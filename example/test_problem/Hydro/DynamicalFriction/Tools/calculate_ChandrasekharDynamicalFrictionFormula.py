...
version = 'analytical' # 'analytical' or 'interpolate_table' -> 'analytical' means using the analyical result "without" any hard truncation, 'interpolate_table' means using the table generated by A_SET_IC.py
...
def density(rho_s, r0, r, model_name):
    ...
    if model_name == "Burkert":
    	...
    	## TODO : make the parameter be adjustable in the Input file
